...
namespace Auth {
    ...
    public:
        ...
        /// @param ip
        /// @return 
        bool add_user(const std::string& username, const std::string& passwd, const std::string& ip);
        ...
        /// @param ip
        /// @return 
        bool verify(const std::string& username, const std::string& passwd, const std::string& ip);
