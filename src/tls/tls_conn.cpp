...
std::vector<uint8_t> Connection::feed_encryption(std::span<const uint8_t> cipher_in)
{
    if (!cipher_in.empty())
    {
...
std::vector<uint8_t> Connection::encrypt(std::span<const uint8_t> plain_in)
{
    if (!handshake_done_)
    {
...
std::string Connection::info() const
{
...
std::vector<uint8_t> Connection::drain_wbio()
{
...
std::vector<uint8_t> Connection::drive_handshake()
{
