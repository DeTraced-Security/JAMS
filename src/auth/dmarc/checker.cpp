...
void Checker::fetch_and_evaluate(
...
void Checker::evaluate(const DMARCRecord& record, bool is_subdomain, std::shared_ptr<EvalState> state) {
...
std::optional<DMARCRecord> Checker::parse_record(const std::string& txt) {
    DMARCRecord record;
...
Policy Checker::parse_policy(const std::string& value) {
...
std::string Checker::org_domain(const std::string& domain) {
