...
namespace DKIM {
    ...
    std::vector<uint8_t> DKIMSigner::sha256(const std::string& data) {
    ...
    std::string DKIMSigner::canonicalize_body(const std::string& body, const std::string& method) {
        if (method == "relaxed") {
    ...
    std::string DKIMSigner::canonicalize_header(
    ...
    std::string DKIMSigner::build_signature_header(
    ...
    std::string DKIMSigner::build_signing_data(
    ...
    std::unordered_map<std::string, std::vector<std::string>> DKIMSigner::parse_headers(
    ...
    std::string DKIMSigner::build_header_list() const
    {
        std::ostringstream ss;
    ...
    std::string DKIMSigner::lowercase(const std::string &s)
    {
        std::string out = s;
    ...
    std::string DKIMSigner::trim(const std::string &s) {
